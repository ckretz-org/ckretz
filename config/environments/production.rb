...
Rails.application.configure do
  ...
  config.active_job.queue_name_prefix = "ckretz_production"
  ...
  config.hosts = [
    "ckretz.com", # Allow requests from example.com
    /.*\.ckretz\.com/ # Allow requests from subdomains like `www.example.com`
  ]
